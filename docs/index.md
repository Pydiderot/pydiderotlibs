...
- [repere](/pydiderotlibs/repere.html): Permet l'affichage d'un repère du plan interactif (zoom, déplacer).
- [entree](/pydiderotlibs/entree.html): Fonctions d'entrées utilisateur avec des fenêtres tkinter.
- [lycee](/pydiderotlibs/lycee.html) : Regroupe les fonctions principales que sont amenés à utiliser les élèves de lycée en mathématiques (toutes filières confondues).
- [graphique](/pydiderotlibs/graphique.html): Permet l'affichage d'une fenêtre graphique dynamique et une gestion simplifiée des entrées clavier et souris.
